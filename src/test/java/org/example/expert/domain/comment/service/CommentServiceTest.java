...
class CommentServiceTest {
    ...
    void todo의_댓글들을_조회한다() {
        ...
        Comment comment1 = new Comment("contents1", user, null);
        Comment comment2 = new Comment("contents2", user, null);
        ...
        given(commentRepository.findByTodoIdWithUser(todoId)).willReturn(mockComments);
        ...
        assertEquals("test@email.com", result.get(0).getUser().getEmail());
    }
}
